...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="content forum-detail"<?php print $content_attributes; ?>>
    <?php
    ...
    <div class="detail">
      ...
      <div class="sidepad">
        <div class="sidebar">
            <h3 class="view-title">Active Group topics</h3>
            <?php print views_embed_view('clone_of_advanced_forum_active_topics', 'panel_pane_1'); ?>
        </div>
      </div>
